...
<h1>Supportix</h1>
<br><br><br>
<p class="text-medium-emphasis">Iniciar Sesion al Sistema de Tickets de Soporte</p>
...
<h4><a href="./" style="color: white;"><b>SUPPORTIX</b></a></h4>

</div>
<div class="sidebar-brand-narrow" width="46" height="46" alt="CoreUI Logo">
<h4><a href="./" style="color: white;"><b>SX</b></a></h4>
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="./?view=tickets&opt=all">
            <svg class="nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-task"></use>
            </svg> Tickets</a></li>
        <li class="nav-item"><a class="nav-link" href="./?view=projects&opt=all">
            <svg class="nav-icon">
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
          ...
          <ul class="header-nav ms-3">
            <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-end pt-0">
                ...
                </div><a class="dropdown-item" href="./?view=configuration&opt=all">
                  <svg class="icon me-2">
                    <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-settings"></use>
                  </svg> Configuracion</a>
      ...
      <footer class="footer">
        <div><a href="https://evilnapsis.com/">Supportix </a> © 2026 - Evilnapsis.</div>

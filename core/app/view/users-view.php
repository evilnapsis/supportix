...
<div class="row">
	<div class="col-md-12">
<div class="card">
  <div class="card-header bg-primary text-white"><i class="bi-people"></i> Lista de Usuarios</div>
  <div class="card-body">
...
<div class="card">
  <div class="card-header bg-success text-white"><i class="bi-person-plus"></i> Agregar Usuario</div>
  <div class="card-body">
...
<div class="row">
	<div class="col-md-12">
<div class="card">
  <div class="card-header bg-info text-white"><i class="bi-person-gear"></i> Editar Usuario</div>
  <div class="card-body">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Nombre de usuario*</label>
    <div class="col-md-6">
      <input type="text" name="username" value="<?php echo $user->username;?>" required class="form-control" id="username" placeholder="Nombre de usuario">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Email*</label>
